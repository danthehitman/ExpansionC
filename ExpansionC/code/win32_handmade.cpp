                      ...
                      win32_sound_output *SoundOutput, real32 TargetSecondsPerFrame)
{
    ...
    // DEF: Casey talkes about using dimensional analysis here where the SecondaryBufferSize is the common type and we are trying to get to pixels so we 
    // multiply by pixels and divide by the buffer bytes.
